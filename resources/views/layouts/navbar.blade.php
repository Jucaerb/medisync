...
<nav class="navbar navbar-expand-lg bg-body-tertiary bg-5 navbar-transparent">
    <div class="container-fluid navbar-transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            @else
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle text-body-medium" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        {{ Auth::user()->full_name }}
                    </a>

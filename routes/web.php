...
Route::middleware(['authUser:DOCTOR,ADMIN'])->group(function () {
    ...
    Route::delete('/deleteactivity/{id}', [App\Http\Controllers\DoctorController::class, 'deleteActivity'])->name('deleteactivity');
...
Route::middleware(['authUser:DOCTOR,ADMIN,NURSE,BOSS_NURSE'])->group(function () {
    ...
    Route::put('/attention', [App\Http\Controllers\BossNurseController::class, 'attentionModal'])->name('attetion');
